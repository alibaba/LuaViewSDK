...
<ul>
  <li><a href="../$(ldoc.output).html">首页</a></li>
</ul>
# else 
  <li><font color=#777777>首页</font></li>
# end
...
#   if mod.name == this_mod then
  <li><font color=#777777><strong>$(name)</strong></font></li>
#   else
...
<div id="about">
<i>Copyright © 2010-2015 Juhuasuan.com 版权所有</i>
<i style="float:right;"><a href="javascript:scroll(0,0)">返回顶部</a></i>
</div> <!-- id="about" -->
</div> <!-- id="container" -->
</body>
</html>
]==]
-- <a href="../index.html">Last updated 2015-08-24</a>

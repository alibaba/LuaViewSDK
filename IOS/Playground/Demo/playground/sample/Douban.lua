...
function meta:handle()
    ...
    self.list:initParams({
        ...
        Callback = {
            PullDown = function()
                if (self.isLeft) then
                    self.http = self:request("http://api.douban.com/v2/movie/in_theaters?apikey=0df993c66c0c636e29ecbb5344252a4a",
                        function(data)
                    ...
                    self.http = self:request("http://api.douban.com/v2/movie/coming_soon?apikey=0df993c66c0c636e29ecbb5344252a4a",
                        function(data)

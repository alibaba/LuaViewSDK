...
char g_debug_lua[9695] = {
    ...
    ' ',' ',' ',' ','p','r','i','n','t','(',' ','"','(','l','d','b',')',' ','"',' ','.','.',' ','l','o','g','_','s','t','r',' ',')',0xa,
    // print( "(ldb) " .. log_str )
    'e','n','d',0xa,
    // end
    0xa,
    ...
    // --打印表中所有数据
    ' ',' ',' ',' ',' ',' ',' ',' ','p','r','i','n','t','(',' ','s','t','r','i','n','g',':','f','o','r','m','a','t','(',' ','"','%','s','%','s',' ','=',' ','{','"',',',' ','p','r','e','f','i','x',',',' ','n','a','m','e',' ',')',' ',')',0xa,
    ...
    ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','d','e','b','u','g','_','p','r','i','n','t','_','v','a','r','(',' ','k',',',' ','v',',',' ','l','e','v','e','l',' ','+',' ','1',' ',')',0xa,
    // debug_print_var( k, v, level + 1 )
    ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','-','-','e','n','d',0xa,
    // --end
    ' ',' ',' ',' ',' ',' ',' ',' ','e','n','d',0xa,
    // end
    ' ',' ',' ',' ',' ',' ',' ',' ','p','r','i','n','t','(',' ','p','r','e','f','i','x',' ','.','.',' ','"','}','"',' ',')',0xa,
    // print( prefix .. "}" )
    ...
    // if ( var==nil ) then
    ' ',' ',' ',' ',' ',' ',' ',' ','p','r','i','n','t','(','"','d','e','b','u','g','_','p','r','i','n','t','_','e','x','p','r',' ','v','a','r','=','=','n','i','l','"',')',';',0xa,
    ...
    ' ',' ',' ',' ','d','e','b','u','g','_','l','o','g','(',' ','s','t','r','i','n','g',':','f','o','r','m','a','t','(',' ','"','a','d','d',' ','b','r','e','a','k','p','o','i','n','t',' ','%','s',':','%','d','"',',',' ','s','o','u','r','c','e',',',' ','l','i','n','e',' ',')',' ',')',0xa,
    ...
    ' ',' ',' ',' ',' ',' ',' ',' ','d','e','b','u','g','_','l','o','g','(',' ','s','t','r','i','n','g',':','f','o','r','m','a','t','(',' ','"','r','e','m','o','v','e',' ','b','r','e','a','k','p','o','i','n','t',' ','%','s',':','%','d','"',',',' ','s','o','u','r','c','e',',',' ','l','i','n','e',' ',')',' ',')',0xa,
    ...
    // elseif c == "bt" then
    ' ',' ',' ',' ',' ',' ',' ',' ','p','r','i','n','t','(',' ','d','e','b','u','g',':','t','r','a','c','e','b','a','c','k','(','"','"',',',' ','3',')',' ',')',0xa,
    ...
    ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','d','e','b','u','g','.','b','p','s','.','t','r','a','c','e',' ','=',' ','t','r','u','e',0xa,
    // debug.bps.trace = true
    ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','d','e','b','u','g','_','l','o','g','(',' ','"','b','r','e','a','k','p','o','i','n','t',' ','"',' ','.','.',' ','t','b','l','.','n','u','m','b','e','r',' ',')',0xa,
    ...
    // end
    0xa,
    'p','r','i','n','t','(','"','l','o','a','d',' ','d','e','b','u','g',' ','m','o','d','e','l','"',')',';',0xa,

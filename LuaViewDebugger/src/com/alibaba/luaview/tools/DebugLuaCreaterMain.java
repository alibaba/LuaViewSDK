...
public class DebugLuaCreaterMain {
	...
	private void run() {
		byte[] bs = file_to_bytes("/Users/dongxicheng/Desktop/LuaViewSDK/IOS/LuaViewSDK/Classes/lvdebug/debug.lua");
		PrintStream ps = getPrintStream("/Users/dongxicheng/Desktop/LuaViewSDK/IOS/LuaViewSDK/Classes/lvdebug/LVDebugLua.m");
		ps.println();

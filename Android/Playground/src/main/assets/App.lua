...
function meta:onInit()
    self.views = pica:getInstance():render("main.xml")
        ...
        Cell = {
            ...
            SampleCell = {
                ...
                Callback = function(cell, section, row)
                    local pageName = "'widget." .. self.widgetData[row] .. "'"
                    Bridge:jump("require('kit.launcher'):run(" .. pageName .. ")", true)
                end
            }
        }
    })
    ...
    self.sampleList:initParams({
        ...
        Cell = {
            ...
            SampleCell = {
                ...
                Callback = function(cell, section, row)
                    local pageName = "'sample." .. self.sampleData[row] .. "'"
                    Bridge:jump("require('kit.launcher'):run(" .. pageName .. ")", true)
                end
            }
        }

...
button1 = createButton("设置导航栏 标题",0,buttonH*1,scrW,buttonH, function()
			...
			Navigation.title(Image("http://static1.squarespace.com/static/552a5cc4e4b059a56a050501/565f6b57e4b0d9b44ab87107/565f6ddee4b0d9b44ab89215/1449098068446/NYCGifathon2.gif"))
	end);
